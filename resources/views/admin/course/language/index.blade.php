            ...
            <div class="row g-2 align-items-center">
                <div class="card">
                    <div class="card-header">
                        <!-- Page pre-title -->
                        <div class="card-title">Course Language</div>
                        ...
                        <table class="table table-vcenter card-table">
                            ...
                            <tbody>
                                @forelse ($course_languages as $course_language)
                                    <tr>
                                        <td>{{ $course_language->name }}</td>
                                        <td>{{ $course_language->slug }}</td>
                                        <td>
                                            <a href="{{ route('admin.course-language.edit', $course_language->id) }}"
