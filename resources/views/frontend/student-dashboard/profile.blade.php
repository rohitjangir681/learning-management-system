            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-md-8">
                    ...
                    <div class="wsus__dashboard_contant">
                        ...
                        <form action="{{ route('student.profile.update', auth()->user()->id) }}" method="POST" class="wsus__dashboard_profile_update" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-xl-6">
                    ...
                    <div class="wsus__dashboard_contant">
                        ...
                        <form action="{{ route('student.profile.user-social-links', auth()->user()->id) }}" method="POST" class="wsus__dashboard_profile_update">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-xl-6">
