 ...
 <!--===========================
    ...
    <section class="wsus__sign_in sign_up">
        <div class="row align-items-center">
            ...
            <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-9 m-auto wow fadeInRight" style="margin-top: 100px !important;padding:20px 0px;">
                <div class="wsus__sign_form_area">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                            ...
                            <form action="{{ route('register', ['type' => 'student']) }}" method="POST" style="padding-bottom:10px;padding-top:10px;">
                                @csrf
                                <h2>Student Sign Up<span>!</span></h2>
                                <p class="new_user">Already have an account? <a href="{{ route('login') }}">Sign In</a></p>
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="wsus__login_form_input" style="margin-top: 5px;">
                                            <label>Name</label>
                        ...
                        <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                            ...
                            <form action="{{ route('register', ['type' => 'instructor']) }}" method="POST" style="padding-bottom:10px;padding-top:10px;" enctype="multipart/form-data">
                                @csrf
